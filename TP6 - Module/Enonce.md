...
2. Créez ensuite deux dossiers, `prod` et `dev`, chacun avec un `main.tf` utilisant ces modules pour déployer une machine virtuelle avec respectivement pour taille `Standard_B1ms` pour la prod et `Standard_B1s` pour la dev
